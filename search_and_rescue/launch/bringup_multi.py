...
def generate_launch_description():
    ...
    gscam_config = DeclareLaunchArgument(
        "gscam_config",
        default_value="udpsrc port=5093 ! application/x-rtp, payload=96 ! rtpjitterbuffer ! rtph264depay ! avdec_h264  ! videoconvert",
    )
                ...
                actions=[
                    ...
                    Node(
                        ...
                        parameters=[
                            ...
                            {"frame_id": "camera"},
                            # {
                            #     "gscam_config": f"udpsrc port= {udp_video_port_command} ! application/x-rtp, payload=96 ! rtpjitterbuffer ! rtph264depay ! avdec_h264  ! videoconvert",
                            # },
